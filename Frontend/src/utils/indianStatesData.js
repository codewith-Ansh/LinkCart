const BASE_STATE_CITIES = {
    ...
    'Karnataka': ['Bangalore', 'Bengaluru', 'Mysore', 'Mysuru', 'Hubli', 'Mangalore', 'Belgaum', 'Gulbarga', 'Davanagere', 'Bellary'],
...
const STATE_REGION_OPTIONS = {
    ...
    'Uttar Pradesh': ['Agra', 'Aligarh', 'Allahabad', 'Prayagraj', 'Ambedkar Nagar', 'Amethi', 'Amroha', 'Auraiya', 'Azamgarh', 'Baghpat', 'Bahraich', 'Ballia', 'Balrampur', 'Banda', 'Barabanki', 'Bareilly', 'Basti', 'Bhadohi', 'Bijnor', 'Budaun', 'Bulandshahr', 'Chandauli', 'Chitrakoot', 'Deoria', 'Etah', 'Etawah', 'Ayodhya', 'Farrukhabad', 'Fatehpur', 'Firozabad', 'Gautam Buddha Nagar', 'Ghaziabad', 'Ghazipur', 'Gonda', 'Gorakhpur', 'Hamirpur', 'Hapur', 'Hardoi', 'Hathras', 'Jalaun', 'Jaunpur', 'Jhansi', 'Kannauj', 'Kanpur Dehat', 'Kanpur Nagar', 'Kasganj', 'Kaushambi', 'Kushinagar', 'Lakhimpur Kheri', 'Lalitpur', 'Lucknow', 'Maharajganj', 'Mahoba', 'Mainpuri', 'Mathura', 'Mau', 'Meerut', 'Mirzapur', 'Moradabad', 'Muzaffarnagar', 'Pilibhit', 'Pratapgarh', 'Raebareli', 'Rampur', 'Saharanpur', 'Sambhal', 'Sant Kabir Nagar', 'Shahjahanpur', 'Shamli', 'Shravasti', 'Siddharth Nagar', 'Sitapur', 'Sonbhadra', 'Sultanpur', 'Unnao', 'Varanasi'],
    'West Bengal': ['Alipurduar', 'Bankura', 'Birbhum', 'Bardhaman', 'Cooch Behar', 'Dakshin Dinajpur', 'Darjeeling', 'Hooghly', 'Howrah', 'Jalpaiguri', 'Kalimpong', 'Kolkata', 'Malda', 'Murshidabad', 'Nadia', 'North 24 Parganas', 'Paschim Medinipur', 'Purba Medinipur', 'Purulia', 'South 24 Parganas', 'Uttar Dinajpur'],
    ...
    'Ladakh': ['Leh', 'Kargil', 'Drass', 'Diskit', 'Padum', 'Nyoma', 'Nubra', 'Zanskar', 'Turtuk'],
...
const uniqueSorted = (items) =>
    [...new Set(items.filter(Boolean).map(toDisplayName))].sort((a, b) => a.localeCompare(b));

export const INDIAN_STATES_CITIES = Object.fromEntries(
    Object.keys(BASE_STATE_CITIES)
        .sort((a, b) => a.localeCompare(b))
        .map((state) => [
            state,
            uniqueSorted([...(BASE_STATE_CITIES[state] || []), ...(STATE_REGION_OPTIONS[state] || [])]),
        ])
);
